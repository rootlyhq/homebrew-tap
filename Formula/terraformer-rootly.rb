class TerraformerRootly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      ...
      def install
        bin.install "terraformer-rootly-darwin-arm64"
      end
    end
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      ...
      def install
        bin.install "terraformer-rootly-darwin-amd64"
      end
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      ...
      def install
        bin.install "terraformer-rootly-linux-arm64"
      end
    end
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      ...
      def install
        bin.install "terraformer-rootly-linux-amd64"
      end
    end
  end
end
